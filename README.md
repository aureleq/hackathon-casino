...
## Introduction
This repository contains examples to get started with Sigfox and SiPy board for Casino hackathon (http://hackandshop.bemyapp.com/)

## How to use Sigfox during the hackathon-casino
